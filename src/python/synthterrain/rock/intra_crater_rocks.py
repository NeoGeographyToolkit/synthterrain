...
# TODO: Load these from input parameters!
    ...
    def _sampleRockLocations(self):
        ...
        # TODO
        self._location_probability_map = np.zeros(self._terrain.dem_size([1, 0]), 'single')
        ...
        for i in range(0, s[0]*s[1]):
            ...
            d = math.sqrt(
                (self._terrain.xs - m_pos(1))^2 +
                (self._terrain.ys - m_pos(2))^2) # sizeof dem
    ...
    def _sampleRockDiameters(self):
        ...
        eps = 2.2204e-16
        direct_rock_area_sq_m = np.sum(self._location_probability_map > eps)
